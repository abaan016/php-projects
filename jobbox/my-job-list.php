                      ...
                      if($query)
                      {
                        ...
                        <div class="col-lg-6">
                          <div class="card-style-2 hover-up">
                            <div class="card-head">
                              <div class="card-image"> <img style="width: 50px; height: 50px;" src="assets/imgs/brands/<?php echo $row["Uploadefile"] ?>" alt="jobBox"></div>
                              <div class="card-title"> 
                                <h6><?php echo $row["Jobtitle"] ?></h6><span class="job-type"><?php echo $row["Workplace"] ?></span>
                              </div>
                            </div>
