...
<body class="bg-light">
        ...
        <!-- PAGE CONTENT -->
        <div class="container">
            <h1 class="display-4 mt-5">Fatima Memorial Hospital</h1>
            <div class="row my-5 card p-3">
            <h1 class="fw-bold my-3">About</h1>
                <div class="col-lg-4 mx-auto">
                    <img src="assets/img/hospitals/fatimahospital.jpeg" class="img-fluid" alt="">
                </div>
                <div class="col-lg-8 mt-5">
                    <?php   require_once("config.php");
                    $sql = "SELECT `HospitalName`, `Email`,`Address`, `ContactNum`, `City` FROM `reghospital` WHERE Hid=2";
